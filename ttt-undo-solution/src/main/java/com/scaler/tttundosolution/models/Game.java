...
import com.scaler.tttundosolution.exceptions.GameInvalidationException;
...
public class Game {
    ...
    public void undo() throws EmptyGamesListException {
        if (!moves.isEmpty()) {
            ...
            throw new EmptyGamesListException("Undo operation can't be performed as the moves list is empty");
        }
    }
}
