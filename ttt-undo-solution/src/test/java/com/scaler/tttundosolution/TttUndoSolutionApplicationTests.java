package com.scaler.tttundosolution;

import com.scaler.tttundosolution.controllers.GameController;
import com.scaler.tttundosolution.exceptions.EmptyGamesListException;
import com.scaler.tttundosolution.models.*;
import com.scaler.tttundosolution.strategies.WinningStrategy;
import com.scaler.tttundosolution.strategies.WinningStrategyImpl;
...
@SpringBootTest
@ContextConfiguration(classes = TttUndoSolutionApplication.class)
class TttUndoSolutionApplicationTests {
    ...
    @Test
    public void testUndoFunctionality1() throws EmptyGamesListException {
        board = game.getBoard();
        Player player1 = players.get(0);
    ...
    @Test
    public void testUndoFunctionality2() throws EmptyGamesListException {
        board = game.getBoard();
        Player player1 = players.get(0);
        Player player2 = players.get(1);
        List<Move> moves = game.getMoves();
    ...
    public void testUndoFunctionality3() {
        ...
        Throwable exception = assertThrows(EmptyGamesListException.class, () -> gameController.undo(game));
